...
/**
 * Validate an unknown value against the User schema and return the parsed user.
 *
 * @param input - The value to validate as a `User`
 * @returns The validated `User`
 * @throws Error containing structured validation errors when validation fails
 */
