...
export type User = z.infer<typeof UserSchemassss>sss

/**
 * Validates an unknown value against the User schema and returns the validated user object.
 *
 * @param input - The value to validate as a User
 * @returns The validated `User` object
 * @throws Error - If validation fails; the error message is a JSON string of the schema validation tree (result.error.treeify())
 */
