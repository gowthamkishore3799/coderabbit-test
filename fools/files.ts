...
/**
 * Validate and parse an unknown value into a User object.
 *
 * @param input - The untrusted value to validate as a User
 * @returns The validated User object
 * @throws An Error containing the Zod v4 structured error (result.error.treeify()) when validation fails
 */
